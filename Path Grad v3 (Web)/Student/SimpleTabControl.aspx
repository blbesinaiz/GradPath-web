        ...
        <tr>
            <td>
                <asp:Button Text="Profile" BorderStyle="None" ID="Tab1" CssClass="Initial" runat="server"
                    OnClick="Tab1_Click" />
                <asp:Button Text="Curriculum" BorderStyle="None" ID="Tab2" CssClass="Initial" runat="server"
                    OnClick="Tab2_Click" />
                        ...
                        <table style="width: 100%; border-width: 1px; border-color: #666; border-style: solid">
                            <tr>
                                <td>
                                    ...
                                    <asp:TextBox ID="txt_newPassword" runat="server"></asp:TextBox><br />
                                    <asp:Label ID="ConfirmPassword" runat="server" Text="Confirm Password: "></asp:Label>
                                    <asp:TextBox ID="txt_confirmPassword" runat="server"></asp:TextBox><br />
                                    <asp:Label ID="Avatar" runat="server" Text="Avatar: "></asp:Label>
